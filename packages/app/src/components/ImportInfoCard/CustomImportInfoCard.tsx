...
export const CustomImportInfoCard = () => {
  ...
  return (
    <InfoCard
      ...
      deepLink={{
        ...
        link: '/docs/default/component/productcore-backstage/plugins/catalogimport-quickstart/',
      }}
    >
      ...
      <Typography variant="subtitle2" color="textSecondary" paragraph>
        Example:{' '}
        <code>
          https://bitbucket.org/wwtw/template-me-nextjs/src/master/catalog-info.yaml
        </code>
      </Typography>
      <Typography variant="body2" paragraph>
