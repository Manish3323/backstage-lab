...
import { FavouriteTemplate, scaffolderPlugin } from '@backstage/plugin-scaffolder';
...
const getTemplateCardProps = (
  ...
  return {
    ...
    docsUrl: (template.metadata?.annotations?.["tw.com/tech-docs-link"] as string)  ??  '',
  };
};
...
export const TemplateCard = ({ template, deprecated }: TemplateCardProps) => {
  ...
  const rootLink = useRouteRef(scaffolderPlugin.routes.root);
    ...
    <Card>
      ...
      <CardContent style={{ display: 'grid' }}>
        <Box className={classes.box}>
          ...
          {templateProps.docsUrl && 
          <p>
            For more Information, Read the
          <Link className={classes.docsStyle} href={templateProps.docsUrl}>
            Quick Start Docs
          </Link>
          </p>}
        </Box>
