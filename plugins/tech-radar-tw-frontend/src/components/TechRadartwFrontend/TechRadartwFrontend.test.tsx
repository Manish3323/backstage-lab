...
import { TechRadartwFrontend } from './TechRadartwFrontend';
import { TechRadarLoaderResponse, techRadarApiRef, TechRadarApi } from '@backstage/plugin-tech-radar';

import { errorApiRef } from '@backstage/core-plugin-api';

describe('TechRadartwFrontend', () => {
  beforeAll(() => {
      ...
      wrapInTestApp(
        <ThemeProvider theme={lightTheme}>
          <TestApiProvider apis={[[techRadarApiRef, mockClient]]}>
            <TechRadartwFrontend {...techRadarProps} />
          </TestApiProvider>
        </ThemeProvider>,
      ),
    );
