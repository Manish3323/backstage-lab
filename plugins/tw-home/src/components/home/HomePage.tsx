    ...
    <Page themeId="home">
        ...
        <Content>
            ...
            <Grid container spacing={2} direction="row">
                ...
                <Grid item xs={12} md={4}>
                    <Paper className={classes.paper}>
                        <CreateCard title="Ask the Community" description="Join our Slack channel to ask questions and get support from the Dev Portal community" action="Join the Conversation" href="_blank"/>
                    </Paper>
                </Grid>

                <Grid item xs={12} md={4}>
                    <Paper className={classes.paper}>
                        <CreateCard title="Request A New Feature" description="Reach out to the Engineering team to request a new feature for the Dev Portal" action="Submit A Request" href="_blank"/>
                    </Paper>
                </Grid>
